...
//                    M32F4xx\src\stm32f4xx_usart.c                           /
//    Command line =  E:\Sakura_Robot_Trunking\01_Terminal\WSN\02_Program\WSN /
//                    _STM32F407_uCOSii\EvalBoards\ST\STM3240G-EVAL\BSP\ST\ST /
//                    M32F4xx\src\stm32f4xx_usart.c -D USE_STDPERIPH_DRIVER   /
...
//                    _STM32F407_uCOSii\EvalBoards\ST\STM3240G-EVAL\uCOS-II\I /
//                    AR\FLASH\List\stm32f4xx_usart.s                         /
//                                                                            /
//                                                                            /
///////////////////////////////////////////////////////////////////////////////

        NAME stm32f4xx_usart
...
??USART_Init_0:
        ...
        LDRH     R0,[R4, #+12]
        MOV      R9,R0
        LDR.N    R0,??DataTable1_6  ;; 0xffffe9f3
        ANDS     R9,R0,R9
        LDRH     R0,[R5, #+4]
        LDRH     R1,[R5, #+8]
        ORRS     R0,R1,R0
